...
class MediaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create media" do
    assert_difference("Media.count") do
      post media_index_url, params: { media: { exemple_musical_id: @media.exemple_musical_id, type_media: @media.type_media, url: @media.url } }
    end
  ...
  test "should update media" do
    patch media_url(@media), params: { media: { exemple_musical_id: @media.exemple_musical_id, type_media: @media.type_media, url: @media.url } }
