...
class EnregistrementMusicauxControllerTest < ActionDispatch::IntegrationTest
  setup do
    @enregistrement_musical = enregistrement_musicaux(:one)
  end

  test "should get index" do
    get enregistrement_musicaux_url
  ...
  test "should destroy enregistrement_musical" do
    ...
    assert_redirected_to enregistrement_musicaux_url
  end
end
