...
class InstrumentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create instrument" do
    assert_difference("Instrument.count") do
      post instruments_url, params: { instrument: { brand: @instrument.brand, description: @instrument.description, model: @instrument.model, serial_number: @instrument.serial_number, year: @instrument.year } }
    end
  ...
  test "should update instrument" do
    patch instrument_url(@instrument), params: { instrument: { brand: @instrument.brand, description: @instrument.description, model: @instrument.model, serial_number: @instrument.serial_number, year: @instrument.year } }
