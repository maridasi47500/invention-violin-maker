...
class ExplorationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create exploration" do
    assert_difference("Exploration.count") do
      post explorations_url, params: { exploration: { audio_reponse_url: @exploration.audio_reponse_url, fire_point_id: @exploration.fire_point_id, lilypond_reponse: @exploration.lilypond_reponse, notes: @exploration.notes, violinist_name: @exploration.violinist_name } }
    end
  ...
  test "should update exploration" do
    patch exploration_url(@exploration), params: { exploration: { audio_reponse_url: @exploration.audio_reponse_url, fire_point_id: @exploration.fire_point_id, lilypond_reponse: @exploration.lilypond_reponse, notes: @exploration.notes, violinist_name: @exploration.violinist_name } }
